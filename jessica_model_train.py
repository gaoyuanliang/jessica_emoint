...
fear_tagger = train_tagger(texts = fear_texts,
	tags = fear_tags,
	tagger_model_path = '/Downloads/fear_tagger.h5',
	epochs = 10)
'''
Epoch 10/10
...
anger_tagger = train_tagger(texts = anger_texts,
	tags = anger_tags,
	tagger_model_path = '/Downloads/anger_tagger.h5',
	epochs = 10)
'''
Epoch 10/10
...
joy_tagger = train_tagger(texts = joy_texts,
	tags = joy_tags,
	tagger_model_path = '/Downloads/joy_tagger.h5',
	epochs = 10)
'''
Epoch 10/10
...
sadness_tagger = train_tagger(texts = sadness_texts,
	tags = sadness_tags,
	tagger_model_path = '/Downloads/sadness_tagger.h5',
	epochs = 10)
'''
Epoch 10/10
